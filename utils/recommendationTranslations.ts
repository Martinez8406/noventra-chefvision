...
export const RECOMMENDATION_BADGE_I18N: Record<DishRecommendationType, Record<PublicMenuLocale, string>> = {
  ...
  oferta_tygodnia: {
    ...
    ar: 'عرض الأسبوع',
    uk: 'Пропозиція тижня',
    de: 'Angebot der Woche',
    es: 'Oferta de la semana',
    it: 'Offerta della settimana',
    ko: '이번 주 특선',
    ja: '今週のおすすめ',
    fr: 'Offre de la semaine',
    cs: 'Nabídka týdne',
    nl: 'Aanbieding van de week',
    zh: '本周特惠',
  },
};
...
export const RECOMMENDATION_HEADER_I18N: Record<DishRecommendationType, Record<PublicMenuLocale, string>> = {
  ...
  zestaw: {
    ...
    en: 'Most popular bundle',
    he: 'השילוב הפופולרי ביותר',
    ar: 'الباقة الأكثر طلباً',
    uk: 'Найпопулярніший набір',
    de: 'Beliebtestes Bundle',
    es: 'El pack más popular',
    it: 'Il bundle più richiesto',
    ko: '가장 인기 있는 세트',
    ja: '一番人気のセット',
    fr: 'La formule la plus populaire',
    cs: 'Nejoblíbenější balíček',
    nl: 'Meest populaire bundel',
    zh: '最受欢迎套餐',
  },
  oferta_tygodnia: {
    pl: 'Oferta tygodnia',
