...
function fallbackTranslations(categories) {
  ...
  for (const c of categories) {
    out[c] = { en: c, he: c, ar: c, uk: c, de: c, es: c, it: c, ko: c, ja: c, fr: c, cs: c, nl: c, zh: c };
  }
  return out;
}
...
export async function handleSaveMenuCategories({ authorization, body = {} }) {
  ...
  if (apiKey) {
    try {
      ...
      const prompt = `Przetłumacz poniższe nazwy kategorii menu z języka polskiego na en (British English), he (hebrajski), ar (arabski), uk, de, es, it, ko, ja (japoński), fr, cs, nl i zh (chiński uproszczony).
Zasady:
...
{
  "Nazwa kategorii PL": { "en": "...", "he": "...", "ar": "...", "uk": "...", "de": "...", "es": "...", "it": "...", "ko": "...", "ja": "...", "fr": "...", "cs": "...", "nl": "...", "zh": "..." }
}`;
